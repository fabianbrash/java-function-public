...
k8s_resource('java-function-public', port_forwards=["8080:8080"],
    extra_pod_selectors=[{'carto.run/workload-name': 'java-function-public', 'app.kubernetes.io/component': 'run'}])
